package mobileworld;
	...
	public class signup {
	    ...
	    {
	    	System.setProperty("webdriver.chrome.driver","C:\\Users\\olapu.sudharshan\\Downloads\\chromedriver_win32\\chromedriver.exe");
	        ...
	        driver.findElement(By.cssSelector("input[type='text']")).sendKeys("Sudarshan");
	        driver.findElement(By.xpath("//input[@placeholder='Last Name']")).sendKeys("olapu");
	        driver.findElement(By.xpath("//input[@placeholder='Enter Email']")).sendKeys("sudarshan@gmail.com");
